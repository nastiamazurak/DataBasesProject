        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email = table.Column<string>(type: "character varying(40)", nullable: true),
                    password = table.Column<string>(type: "character varying(30)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_citizen_district",
                        column: x => x.district_id,
                        principalTable: "district",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_citizen_Role_RoleID",
                        column: x => x.RoleID,
                        principalTable: "Role",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    citizen_id = table.Column<int>(nullable: true),
                    updates_count = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_check_updates", x => x.id);
                    table.ForeignKey(
                        name: "check_updates_citizen_id_fkey",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_check_updates_citizen_id",
                table: "check_updates",
                column: "citizen_id");
